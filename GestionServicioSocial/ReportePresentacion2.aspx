<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ReportePresentacion2.aspx.cs" Inherits="GestionServicioSocial.ReportePrecentacion2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <article style="padding-left:150px">
        <asp:Label ID="txtNumeroControl" runat="server" Text=""></asp:Label>
       </article>
        <br />
        <br />
