<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ReporteSolicitud2.aspx.cs" Inherits="GestionServicioSocial.ReporteSolicitud2" %>
     ...
     <article style="padding-left:150px">
        ...
        <div style="padding-left:150px">
            ...
            <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
                <report filename="informeSolicitud.rpt">
                </report>
