<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ReportePrecentacionResidenciaInterno2.aspx.cs" Inherits="GestionServicioSocial.ReportePrecentacionResidenciaInterno2" %>
    ...
    <article style="padding-left:150px">
        ...
        <div style="padding-left:150px">
            ...
            <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
                <report filename="informePrecentacionRecidenciaInterno2.rpt">
                </report>
