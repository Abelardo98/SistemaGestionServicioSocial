<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ReportePresentacionInterno2.aspx.cs" Inherits="GestionServicioSocial.ReportePrecentacionInterno2" %>
    ...
    <article style="padding-left:150px">
        ...
        <div style="padding-left:150px">
            ...
            <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
                <report filename="informePrecentacionInterno2.rpt">
                </report>
